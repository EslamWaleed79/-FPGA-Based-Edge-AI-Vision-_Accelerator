...
HD_PWD='C:/Users/compumarts/Desktop/again/again.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_conv_accelerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_conv_accelerator.tcl -notrace
