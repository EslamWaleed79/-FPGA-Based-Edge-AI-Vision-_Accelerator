...
HD_PWD='C:/Users/compumarts/Desktop/again/again.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_conv_accelerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_conv_accelerator.tcl
